...
RDEPEND="dev-haskell/cairo:=[profile?]
	...
	>=dev-haskell/gi-cairo-connector-0.0.1:=[profile?]
	>=dev-haskell/gi-cairo-render-0.0.1:=[profile?]
	...
	>=dev-haskell/gtk-sni-tray-0.1.6.0:=[profile?]
	>=dev-haskell/gtk-strut-0.1.3.0:=[profile?]
	...
	>=dev-haskell/scotty-0.11.2:=[profile?] <dev-haskell/scotty-0.12.0:=[profile?]
